...
class Scripts extends Megad
{
    ...
    function runscript(int $id_object, $id_method, string $method=null)
    {
       ...
       $this->object->set_property($id_object, $id_method, $method); //Меняем состояние объекта
//print_r("cd ".$dir."/../scripts/custom_scripts && php -f {$script->link} &");
       $dir = str_replace(' ', '\ ', __DIR__);
       exec("cd ".$dir."/../scripts/custom_scripts && php -f {$script->link} {$method} &"); //выполняем внешний скрипт
